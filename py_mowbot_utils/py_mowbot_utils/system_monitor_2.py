...
class SensorMonitorNode(Node):
    def __init__(self):
        ...
        self.create_subscription(Imu, '/gps/heading', self.generic_callback('/gps/heading'), 10)
        self.create_subscription(NavSatFix, '/gps/fix', self.generic_callback('/gps/fix'), 10)
